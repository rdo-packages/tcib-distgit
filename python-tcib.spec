...
# Setup roles
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datadir}/ansible/roles/container_image_build/* \
  %{buildroot}%{_datadir}/ansible/roles/container_image_build
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datadir}/ansible/roles/modify_container_image/* \
  %{buildroot}%{_datadir}/ansible/roles/modify_container_image
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datadir}/%{pypi_name}/roles/container-images/* \
...
rm -rf %{buildroot}%{python3_sitelib}%{_datadir}/%{pypi_name}/container-images
